...
/**
 * Provides a pop-up interface which allows the user to select or
 * deselect files from the database. These selections are then used
 * to make SQL queries in the DatabaseAccess class.
 * 
...
public class DatabasePane extends JFrame{
			...
			PatternGUI callingGUI, Model model, DatabaseAccess db)
	{
		...
		go.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				mainModel.appendModel(database.queryDatabase(mainGUI, mainModel, database));
	 ...
	 * 
	 * @param packages the list of class names retrieved from the database
	 ...
	 * selected using the DatabasePane
	 * 
	 * @return ArrayList<String> of class names
	 */
