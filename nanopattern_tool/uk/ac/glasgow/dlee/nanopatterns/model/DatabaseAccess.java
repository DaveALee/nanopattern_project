...
import uk.ac.glasgow.dlee.nanopatterns.controller.PatternGUI;

/**
 * This class allows a database to be set up, accessed and queried. 
 * Analysis results can be stored in the database, and when retrieved,
 * are added to the datastructure.
 * 
...
public class DatabaseAccess {
	 ...
	 * 
	 * @param databaseLocation the file location of the database
	 */
	 ...
	 * @param theModel model allows the datastructure to be queried
	 ...
	 * 
	 * @param gui a link to the controller class
	 * @param model the model data is taken from 
	 * @param db allows access to the database
	 * @return Model containing the results of the query.
	 */
	public Model queryDatabase(PatternGUI gui, Model model, DatabaseAccess db )
	{
		Connection con = null;
		Statement stmt = null;
		...
		{
			//SQL is malformed
			JOptionPane.showMessageDialog(this.dbPane, "Invalid Database Selection",
					"Error", JOptionPane.ERROR_MESSAGE);
			//run the selection again
			initDbSelection(gui, model, db);
