...
/**
 * View to display the model as a textual display, providing detailed
 * information about the packages detected by the analysis.
 * 
...
public class TextDisplay implements ViewInterface{
	...
	/**
	 * Constructor to set up the text display
	 * @param modelToDisplay the model that will be displayed
	 */
	 ...
	 * 
	 * @return JTabbedPane a tabbed pane to display the results
	 */
	 ...
	 * 
	 * @param saveLocation the desination of the saved file
	 */
