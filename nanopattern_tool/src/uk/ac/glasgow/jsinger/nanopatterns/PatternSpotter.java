...
public class PatternSpotter {
	...
	/**
	 * Finds the name of the class from the filename which may have 
	 * a package name before the class name.
	 * 
	 * @param name the filename of the class
	 * @return the name of the class, extracted from the filename
	 */
